...
public class ZhihuThemeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ZhihuThemeAdapter(OnListFragmentInteract listener) {
        zhihuStories = new ArrayList();
        this.listener = listener;
    }

    public void OnUpdate(ZhihuThemeList json, boolean refresh) {
        if (json == null) return;
        ...
        if (json.getImage() != null) image = json.getImage();
        if (json.getDescription() != null) description = json.getDescription();
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (zhihuStories.get(position - 1) instanceof String) {
                ...
                if (viewHolder.zhihuStory.getImages() != null)
